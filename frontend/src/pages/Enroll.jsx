...
export default function Enroll() {
  ...
  const { addToQueue, removeFromQueue, queue, current } = useEnrollQueue()
          ...
          <div className="form-group">
            ...
            {sectionList.length > 0 ? (
              ...
              <div className="form-input" style={{ display: 'flex', alignItems: 'center', color: 'var(--text3)', fontSize: 13, opacity: 0.6 }}>
                {!classVal ? 'Select a class first' : needsStream && !streamVal ? 'Select a stream' : 'No sections — add in Manage'}
              </div>
            )}
          </div>
          <div className="form-group">
                      ...
                      {isProcessing && (
                        <div style={{ marginTop: 6 }}>
                          <div style={{ height: 3, borderRadius: 999, background: 'var(--border)', overflow: 'hidden' }}>
                            <div className="enroll-progress-shimmer" style={{
                              height: '100%',
                              background: 'linear-gradient(90deg, var(--nps-blue), var(--secondary))',
                              borderRadius: 999,
                            }} />
                          </div>
                        </div>
